...
func main() {
    ...
    edwin = Trainer{name: "Edwin", id: "2", pokemon: []Pokemon{
        ...
        makePokemon("42", "Zubat", 100),
        makePokemon("88", "Grimer", 100),
        makePokemon("12", "Butterfree", 100),
        makePokemon("55", "Golduck", 100),
        makePokemon("56", "Mankey", 100),
        makePokemon("150", "MewTwo", 100)},
        action: make(chan *ActionMessage),
        outbox: make(chan []byte),
        connections: make(map[*BattleConnection] bool),
        battling: false,
